...
export type Authorization_code_PKCE = {
    ...
    request_access_token: {
        ...
        error_response: {
            error: string
            error_description: strijng
        }
    }
}

export type AuthorizationCodePKCE = CamelizeKeys<Authorization_code_PKCE>
    ...
    Player: {
        get_playback_state: {
            ...
            response: {
                ...
                {
                    current_playing_type: "track"
                    item: TrackObject
                } |
                {
                    current_playing_type: "episode"
                    item: EpisodeObject
                } |
                {
                    current_playing_type: "unkown"
                    item: null
                }
            )
            error_response: {
...
export type WebAPI = CamelizeKeys<Web_API>